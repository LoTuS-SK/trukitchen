  ...
  return (
    ...
    <div className='item_pal' tabIndex="0" >
          ...
          <div className='item_pal' tabIndex="0" >
            ...
            <div className='price-pl'>550 ₽</div>
          </div>
          ...
          <div className='item_pal' tabIndex="0" >
            ...
            <span className='price-pl'>820 ₽</span>
          </div>
          ...
          <div className='item_pal' tabIndex="0" >
            ...
            <span className='price-pl'>460 ₽</span>
          </div>
          ...
          <div className='item_pal' tabIndex="0" >
            ...
            <span className='price-pl'>1190 ₽</span>
          </div>
